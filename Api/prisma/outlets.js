...
const levels = {
  ...
  8: ['8024', '8050', '8072'],
  9: ['9024', '9050', '9072'],
  10: ['10024', '10050', '10072'],
  11: ['11024', '11050', '11072'],
  12: ['12024', '12050', '12072'],
  13: ['13024', '13050', '13072'],
  14: [null, null, null],
  15: [null, null, null],
  16: [null, null, null],
  17: [null, null, null],
...
export const outlets = Object.entries(levels)
  .flatMap(([level, rooms]) =>
    rooms.map((room, index) => ({
      id: `level-${level}-station-${index + 1}`,
      level: Number(level),
